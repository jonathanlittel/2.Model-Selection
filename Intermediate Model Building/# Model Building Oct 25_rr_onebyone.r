...
compTable <- stargazer(glm0, glm1, glm2, glm3, glm6, glm7, glm8,
                       glm9, glm10, type = "html",
                       ci = TRUE)

write(compTable, file = "step_comparison_rr_onebyone.html", append = TRUE)

rocs <- c(roc0$auc,roc1$auc,roc2$auc,
          roc3$auc,roc5$auc,roc6$auc,
          roc7$auc,roc8$auc,roc9$auc,roc10$auc)

write(rocs, file = "step_comparison_rr_onebyone.html", append = TRUE)
