...
xtabs(~default + unique_segments, data = df.rap)
...
# Now let's try adding a single account, Total Assets
model2 <- "default ~ log(TOTAL.ASSETS + 1)"
...
model5 <- "default ~ log(TOTAL.ASSETS + 1) + COGS.Margin + EBITDA.Margin. + 
...
roc5 <- roc(df.train$default, pred5)
roc5$auc

# Hmm, that seemed to help, but let's put region on the back burner.
model6 <- "default ~ log(TOTAL.ASSETS + 1) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
	 Total.Debt.Service"
...
roc6 <- roc(df.train$default, pred6)
roc6$auc


# Let's look at the percentage of sales to the largest buyer
model7 <- "default ~ log(TOTAL.ASSETS + 1) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer "
...
roc7 <- roc(df.train$default, pred7)
roc7$auc


# Let's add in all the qualitative ratings
model8 <- "default ~ log(TOTAL.ASSETS + 1) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
...
roc8 <- roc(df.train$default, pred8)
roc8$auc

# Add number of sales channels
model9 <- "default ~ log(TOTAL.ASSETS + 1) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc9 <- roc(df.train$default, pred9)
roc9$auc

# Switch to a dummy for >1 segment
model9a <- "default ~ log(TOTAL.ASSETS + 1) + COGS.Margin + EBITDA.Margin. + 
Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
Total.Debt.Service +
max_pct_per_buyer +
Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc9a <- roc(df.train$default, pred9a)
roc9a$auc

# Using variables in risk rating
model10 <- "default ~ Sales + factor(unique_segments) + Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality + Cash.Conversion.Cycle. +
...
roc10 <- roc(df.train$default, pred10)
roc10$auc

# 
model11 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc11 <- roc(df.train$default, pred11)
roc11$auc
...
#
model12 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + Adjusted.EBITDA + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc12 <- roc(df.train$default, pred12)
roc12$auc

# Add segments
model13 <- "default ~ log(TOTAL.ASSETS + 10000) + log(Total.current.assets + 10000) + COGS.Margin + EBITDA.Margin. + 
...
roc13 <- roc(df.train$default, pred13)
roc13$auc

# Add sector
model14 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc14 <- roc(df.train$default, pred13)
roc14$auc


# Add Sales 
model15 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc15 <- roc(df.train$default, pred15)
roc15$auc


# Add Renewal and Loan Usage 
model16 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc16 <- roc(df.train$default, pred16)
roc16$auc

# Add Standard deviation of cogs margin 
model17 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	 Total.Asset.Turnover + Current.Ratio + log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc17 <- roc(df.train$default, pred17)
roc17$auc

# Dropping out some variables that aren't too powerful or intuitive
model18 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
...
roc18 <- roc(df.train$default, pred18)
roc18$auc

# Dropping Loan.Type
model18a <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	  log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc18a <- roc(df.train$default, pred18a)
roc18a$auc


# Dropping Loan.Use
model18b <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	  log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc18b <- roc(df.train$default, pred18b)
roc18b$auc


# Dropping both Loan.Type and Loan.Use
model18c <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	  log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
roc18c <- roc(df.train$default, pred18c)
roc18c$auc
...
summary(glm18cWO)
pR2	(glm18cWO)  
pred18cWO <- predict(glm18cWO, df.train, type="response")
roc18cWO <- roc(df.train$default, pred18cWO)
roc18cWO$auc

# # Now try model 18c using on the final year as having a default  # This gives an error that the algorithm did not converge
model18d <- "default_last_year ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	  log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
    ...
    log(Sales + 1 - min(Sales)) +
    margin_sd"
glm18d <- glm(model18d, data=df.train, family="binomial", na.action=na.exclude)
summary(glm18d)
pR2	(glm18d)  
pred18d <- predict(glm18d, df.train, type="response")
roc18d <- roc(df.train$default, pred18d)
roc18d$auc

# # 
model19 <- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	  log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
...
model20<- "default ~ log(TOTAL.ASSETS + 1) + log(Total.current.assets + 1 - min(Total.current.assets)) + COGS.Margin + EBITDA.Margin. + 
	  log( Adjusted.EBITDA + 1 - min(Adjusted.EBITDA)) + Total.Liabilities.Total.Assets +
	 Total.Debt.Service +
	 max_pct_per_buyer +
	 Depth.of.Management + Product.Recognition + Financial.Flexibility + Financial.Strat.Quality +
